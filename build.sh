...
.license-text {
    background: rgba(0,0,0,0.02); border: 1px solid @bd; border-radius: 8px;
    padding: 16px; font-size: 12px; color: @sc; line-height: 1.6;
}
.network-status {
...
.hello-h { color: #8B5CF6; } .hello-e { color: #EC4899; }
.hello-l1 { color: #EF4444; } .hello-l2 { color: #F97316; } .hello-o { color: #10B981; }
